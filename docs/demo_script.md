...
จาก Architecture ระบบเริ่มจาก REST API ผ่าน Security Pre-Processor เพื่อป้องกัน Prompt Injection จากนั้น Intent Router จะส่งงานไปยัง Domain Specialists โดยใช้ RAG ดึงนโยบายจาก Knowledge Base ร่วมกับโมเดล `openai/gpt-oss-20b` บน Groq Cloud API
...
สำหรับ Knowledge Base เรามีเอกสารนโยบายหลัก 5 ฉบับ รวมถึง `macro_catalog.txt` โดย In-Memory RAG จะดึง Chunk ที่เกี่ยวข้องมาใช้ Grounding ร่วมกับโมเดล `openai/gpt-oss-20b` บน Groq Cloud API ครับ

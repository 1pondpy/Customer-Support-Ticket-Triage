...
class BatchTicketInput(BaseModel): ## ควบคุมรูปแบบ JSON ขาเข้าให้ตรง, ส่งตั๋วหลายใบใน Request เดียวได้ โดยส่งก้อน JSON ที่มีคีย์ tickets ครอบ Array ของอ็อบเจกต์ตั๋ว { "tickets": [ {...} , {...}  ] }
